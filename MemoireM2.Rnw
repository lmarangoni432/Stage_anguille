...
save(hauteur_eau,grdata,annee2,bio_ang,patho,lot,ope,data_env,histo_debit,file=str_c(datawd,"data_report.Rdata"))
...
taille_ang_montaison_histo <- read.csv("~/Desktop/git/Stage_anguille/data/taille_ang_montaison_histo.csv", sep = ";", header = TRUE)
...
flottang <- read.xlsx("~/Desktop/Stage M2/Données_Suivi_Flottang.xlsx", sheet = 1)
